...
public class AttendeesController : ControllerBase
{
    ...
    {
        var dbEvent = _context.Events!.AsNoTracking().FirstOrDefault(x => x.Id == attendee.Id);
        if (id != attendee.Id || dbEvent == null)
        {
            return NotFound();
        }
    ...
    {
        var dbExercise = _context.Events!.Find(attendee.Id, attendee.Name, attendee.Email);
        if (dbExercise == null)
        {
